        ...
        <div className='grid grid-cols-2 gap-3 lg:grid-cols-3 place-items-center 2xl:grid-cols-4 py-24 '>
          ...
          <div className="w-full p-4 lg:w-72 2xl:w-80 rounded-lg shadow-xl mt-20 scale-100 hover:scale-105 ease-in duration-200 bg-white">
            ...
            <div className='flex justify-between mt-3'>
              <span className="bg-teal-200 text-teal-800 text-xs px-2 inline-block rounded-full uppercase font-semibold tracking-wide">20% off</span> 
              <ShareIcon/>
            </div>
            <h4 className="mt-1 text-md md:text-xl font-semibold uppercase leading-tight truncate">Anfield Turf</h4>
            ...
            <div className=' sm:mt-0 flex flex-col sm:flex-row sm:justify-between sm:items-center'>
              ...
              <div className='-mt-2 sm:-mt-0 flex flex-row sm:flex-col items-end '> 
                  <h2 className='font-semibold sm:font-bold mt-3 text-start sm:text-end'>₹700</h2>
