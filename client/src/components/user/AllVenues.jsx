...
import turfImage2 from "../../assets/turfImage2.jpeg";
  ...
  useEffect(() => {
    ...
    const getVenues = async () => {
      try {
        ...
        isMounted && setVenues(response.data);
      } catch (err) {
  ...
  return (
    <div className="bg-gradient-to-r from-emerald-50 to-emerald-100">
      <div className="container  mx-auto">
        <div className="grid grid-cols-2 gap-3 min-h-screen lg:grid-cols-3 place-items-center 2xl:grid-cols-4 py-24 ">
          {/* start */}
          {
            venues.length ? 
          ...
          <div className="w-full p-4 lg:w-72 2xl:w-80 rounded-lg shadow-xl mt-20 scale-100 hover:scale-105 ease-in duration-200 bg-white" onClick={()=>navigate(`/venue/${venue._id}`)}>
            ...
            <div className="text-xl md:text-2xl  mt-1 flex gap-3 text-grey-500">
              {venue.sport === 'football' ? <Football /> : venue.sport === 'cricket' ? <Cricket /> : '' }
