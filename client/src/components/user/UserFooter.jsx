  ...
  return (
    <div className="">
      ...
      <footer className="p-4 bg-gradient-to-r from-green-200 to-green-500 rounded-t-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <div>
          <div className="mb-3">
            <span className="text-bold text-3xl italic font-semibold self-center ">
              ENTURF!
            </span>
          </div>
        ...
        <div>
          ...
          <div>
            <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
              ...
              <li>
                <Link to='/notfound' href="#" className="mr-4 hover:underline md:mr-6 ">
                  About
                </Link>
              </li>
              <li>
                <Link to='/notfound' className="mr-4 hover:underline md:mr-6">
                  Privacy Policy
                </Link>
              </li>
              <li>
