  ...
  return (
    <div className=''>
        ...
        <footer className="p-4 bg-gradient-to-r from-green-200 to-green-500 rounded-t-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
           <div>
              <div className='mb-3'>
                <span className='text-bold text-3xl italic font-semibold self-center '>ENTURF!</span> 
              </div>
              <div className='sm:mb-3'>
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" className="hover:underline">abdulvahidkp™</a>. All Rights Reserved.</span>
              </div>
           </div>
           <div>
