          ...
          <div className='h-45 rounded-md md:px-28 lg:px-16 space-y-6'>
            <div className='bg-white w-80 sm:w-96 shadow-md p-8'>
              <div className='space-y-1'>
                <h1 className='text-3xl font-roboto font-bold'>Welcome Back.</h1>
              </div>
              <div className='mt-2 space-y-3'>
                ...
                <button className='duration-300 select-none p-2 mt-2 w-full rounded-full text-white text-xl font-roboto  font-semibold bg-green-400/70 hover:bg-green-500'>Sign in</button>
                <p className='font-semibold text-emerald-600 font-roboto cursor-pointer hover:underline'>Forgot password?</p>
              </div>
            </div>
          </div>
        </div>
